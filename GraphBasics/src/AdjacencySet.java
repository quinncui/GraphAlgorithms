...
public class AdjacencySet {
    ...
    private int V;
    private int E;
    private TreeSet<Integer>[] adjacencySet;
    ...
    public AdjacencySet(String filename) {
        ...
        try (Scanner scanner = new Scanner(file)){
            ...
            adjacencySet = new TreeSet[V];
            for (int i = 0; i < V; i++) {
                adjacencySet[i] = new TreeSet<>();
            }
            // O(E*V)
            for (int i = 0; i < E; i++) {
    ...
    public static void main(String[] args) {
        AdjacencySet adjacencySet = new AdjacencySet("GraphBasics/ajMatrix.txt");
